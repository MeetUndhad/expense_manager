                ...
                Padding(
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      ...
                      //   // DatabaseHelper.columnId : controller.list[index]['_id'],
                      //   DatabaseHelper.amount:
                      //   ,
                      //   DatabaseHelper.payee:
                      //   ,
                      //   DatabaseHelper.chequeno : "ABCD",
                      // };
                      // await dbHelper.updateStatic(
                      //     row: updateRow, table: DatabaseHelper.table, id: DatabaseHelper.columnId);
                      // controller.list1.clear();
                      // controller.getAllDataFromDatabase();
                      // ignore: use_build_context_synchronously
                      Navigator.push(
                          context, MaterialPageRoute(builder: (BuildContext context) => const AddButton(
                      )));
                    },
                   /* onTap: () async{
                      ...
                      await dbHelper.updateStatic(
                          table: DatabaseHelper.table, row: updateRow, id: DatabaseHelper.columnId);
                      controller.list1.clear();
                      controller.getAllDataFromDatabase();
